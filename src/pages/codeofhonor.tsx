        ...
        <div className="code-of-honor-container">
            ...
            <div className="code-of-honor-row">
                ...
                <div className="code-of-honor-rule">
                    ...
                    <img src="/images/copyrightlaws.png" className="rule-image" />
                </div>
                {/* Second Rule */}
                <div className="code-of-honor-rule">
                    <div className="rule-content">
                    ...
                    <img src="/images/collaboration.png"className="rule-image" />
                </div>
            </div>
            {/* Bottom Row */}
            <div className="code-of-honor-row">
                ...
                <div className="code-of-honor-rule">
                    ...
                    <img src="/images/report.png" className="rule-image" />
                </div>
                {/* Fourth Rule */}
                <div className="code-of-honor-rule">
                    <div className="rule-content">
                    ...
                    <img src="/images/accountability.png" className="rule-image" />
                </div>
            </div>
        </div>
    );}
