        ...
        <div className="code-of-honor-container">
            ...
            <div className="code-of-honor-row">
                ...
                <div className="code-of-honor-rule">
                    ...
                    <img src="image1.jpg" alt="Respect Copyright Laws and Promote Academic Integrity" className="rule-image" />
                </div>
                {/* Second Rule */}
                <div className="code-of-honor-rule">
                    <div className="rule-content">
                    ...
                    <img src="image2.jpg" alt="Foster Collaborative Learning" className="rule-image" />
                </div>
            </div>
            {/* Bottom Row */}
            <div className="code-of-honor-row">
                ...
                <div className="code-of-honor-rule">
                    ...
                    <img src="image3.jpg" alt="Report Violations Promptly" className="rule-image" />
                </div>
                {/* Fourth Rule */}
                <div className="code-of-honor-rule">
                    <div className="rule-content">
                    ...
                    <img src="image4.jpg" alt="Uphold Community Accountability" className="rule-image" />
                </div>
            </div>
        </div>
    );}
