...
const CodeOfHonor: React.FC<CodeOfHonorProps> = () => {
    return (
        <div className="code-of-honor-container">
            ...
            <h1 style={{ textAlign: 'center', fontSize: '1.5em', fontWeight: 'bold', marginBottom: '25px' }}>Code of Honor</h1>
            {/* Top Row */}
            ...
            <div style={{ textAlign: 'center', fontSize: '0.8em', color: 'gray', marginTop: '20px' }}>Created by Sarthak</div>
        </div>
    );
};
