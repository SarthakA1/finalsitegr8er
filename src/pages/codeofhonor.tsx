        ...
        <div className="code-of-honor-container">
            ...
            <div className="code-of-honor-row">
                ...
                <div className="code-of-honor-rule">
                    ...
                    <img src="public/images/copyrightlaws.png" alt="Respect Copyright Laws and Promote Academic Integrity" className="rule-image" />
                </div>
                {/* Second Rule */}
                <div className="code-of-honor-rule">
                    <div className="rule-content">
                    ...
                    <img src="public/images/collaboration.png" alt="Foster Collaborative Learning" className="rule-image" />
                </div>
            </div>
            {/* Bottom Row */}
            <div className="code-of-honor-row">
                ...
                <div className="code-of-honor-rule">
                    ...
                    <img src="public/images/report.png" alt="Report Violations Promptly" className="rule-image" />
                </div>
                {/* Fourth Rule */}
                <div className="code-of-honor-rule">
                    <div className="rule-content">
                    ...
                    <img src="public/images/accountability.png" alt="Uphold Community Accountability" className="rule-image" />
                </div>
            </div>
        </div>
    );}
