        ...
        try {
            ...
            //if(user.uid !== selectedPost?.creatorId){
                const newNotification: Notifications = {
                    ...
                    notification: (users?.displayName! || users?.email!.split("@")[0]) + ' has replied to your comment on <a href="/subject/'+selectedPost?.subjectId+'/answers/'+selectedPost?.id+'">'+newAnswer.text+'</a>',
                    isRead: 0,
