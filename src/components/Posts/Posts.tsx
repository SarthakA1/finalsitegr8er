...
const Posts: React.FC<PostsProps> = ({ subjectData, userId }) => {
    ...
    <div className='filter_main_grade_section' style={{display: "flex", alignItems: "center"}}>
        <Text style={{fontSize: "11px", fontWeight: "600"}}>MYP</Text>
        <span className={`filter_main_grade_sub_section ${activeFilters.grade && (activeFilters.grade as string[]).includes('1') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('grade', '1')}>MYP 1</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_grade_sub_section ${activeFilters.grade && (activeFilters.grade as string[]).includes('2') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('grade', '2')}>MYP 2</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_grade_sub_section ${activeFilters.grade && (activeFilters.grade as string[]).includes('3') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('grade', '3')}>MYP 3</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_grade_sub_section ${activeFilters.grade && (activeFilters.grade as string[]).includes('4') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('grade', '4')}>MYP 4</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
    ...
    <div className='filter_main_question_section' style={{display: "flex", alignItems: "center"}}>
        <Text style={{fontSize: "11px", fontWeight: "600"}}>Type</Text>
        <span className={`filter_main_question_sub_section_background ${activeFilters.typeofquestion && (activeFilters.typeofquestion as string[]).includes('Academic Question') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('typeofquestion', 'Academic Question')}>Academic Questions</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_question_sub_section_without_background ${activeFilters.typeofquestion && (activeFilters.typeofquestion as string[]).includes('General Question') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('typeofquestion', 'General Question')}>General Doubts</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
    ...
    <div className='filter_main_criteria_section' style={{display: "flex", alignItems: "center"}}>
        <Text style={{fontSize: "11px", fontWeight: "600"}}>Criteria</Text>
        <span className={`filter_main_criteria_sub_section_background ${activeFilters.criteria && (activeFilters.criteria as string[]).includes('Criteria A') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('criteria', 'Criteria A')}>Criteria A</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_criteria_sub_section_without_background ${activeFilters.criteria && (activeFilters.criteria as string[]).includes('Criteria B') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('criteria', 'Criteria B')}>Criteria B</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_criteria_sub_section_without_background ${activeFilters.criteria && (activeFilters.criteria as string[]).includes('Criteria C') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('criteria', 'Criteria C')}>Criteria C</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
    ...
    <div className='filter_main_difficulty_section' style={{display: "flex", alignItems: "center"}}>
        <Text style={{fontSize: "11px", fontWeight: "600"}}>Difficulty (Academic Questions)</Text>
        <span className={`filter_main_difficulty_sub_section ${activeFilters.difficulty && (activeFilters.difficulty as string[]).includes('easy') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('difficulty', 'easy')}>Easy</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
        <span className={`filter_main_difficulty_sub_section ${activeFilters.difficulty && (activeFilters.difficulty as string[]).includes('medium') ? 'active' : ''}`} onClick={() => handleChangeTopFilter('difficulty', 'medium')}>Medium</span><span style={{marginRight: "5px", marginLeft: "5px"}}>|</span>
