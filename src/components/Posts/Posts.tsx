           ...
           <Stack spacing={8}>
               <div className='filter_main_section'>
                    <div className='filter_main_grade_section'>
                        <Text style={{fontSize: "11.5px", fontWeight: "600"}}>MYP</Text>
                    ...
                    <div className='filter_main_question_section'>
                        <Text style={{fontSize: "11.5px", fontWeight: "600", marginTop: "4px"}}>Type</Text>
                    ...
                    <div className='filter_main_criteria_section'>
                        <Text style={{fontSize: "11.5px", fontWeight: "600", marginTop: "4px"}}>Criteria</Text>
                    ...
                    <div className='filter_main_difficulty_section'>
                        <Text style={{fontSize: "11.5px", fontWeight: "600"}}>Difficulty (Academic Questions)</Text>
